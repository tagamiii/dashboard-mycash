...
Este documento guia a interpretação do Figma e o estilo de codificação (vibe coding) para o projeto.

## 🔹 Pre-flight Check
Antes de gerar qualquer código, execute mentalmente:
...
- Dois estados: Expanded (larga, com texto) e Collapsed (estreita, apenas ícones)
...
- Contém: Botão de menu (abre drawer), Ações principais
...
- Inputs no mobile: Altura mínima 48px, Font-size mínimo 16px (evita zoom no iOS)
